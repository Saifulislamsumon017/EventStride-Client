...
const ErrorPage = () => {
  return (
    <div className="flex flex-col items-center justify-center my-[100px] text-sm max-md:px-4">
      ...
      <p className="text-2xl md:text-5xl font-bold text-gray-800 font-Rancho">
        Page Not Found
      </p>
