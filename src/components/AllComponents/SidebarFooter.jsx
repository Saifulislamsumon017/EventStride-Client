...
const SidebarFooter = () => {
  return (
    <footer className="hidden md:block mt-20 ml-[300px] bg-gradient-to-t from-gray-100 via-white to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-t border-gray-300 dark:border-gray-700">
