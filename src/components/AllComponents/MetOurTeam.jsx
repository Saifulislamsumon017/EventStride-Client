...
const MetOurTeam = () => {
  return (
    <div className="pt-20">
      <h3 className="text-4xl  text-center sm:text-5xl pb-4">Meet our team</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="flex space-x-6 border rounded-xl p-4 shadow hover:shadow-md transition duration-300 ease-in-out">
          <img
            alt=""
